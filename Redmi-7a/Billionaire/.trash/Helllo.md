...
<head>
  ...
  <meta name="description" content="Practising old content">
...
.first:hover, .middle:hover, .last:hover{
...
<body>
  <main>
    <div class="main">
  <div class="box">
    <div class="items first"> 1 </div>
    <div class="items"> 2 </div>
    <div class="items middle"> 3 </div>
    <div class="items"> 4 </div>
    <div class="items last"> 5 </div>
  </div>
  </div>
